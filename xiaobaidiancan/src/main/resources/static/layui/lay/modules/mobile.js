...
function(a) {
    ...
    n.popBottom = function(a) {
        ...
        n.popBottom.index = n.open(t.extend({
            type: 1,
            content: a.content || "",
            shade: !1,
    ...
    o.prototype.on = function(a, e) {
        return "function" == typeof e && (s[a] ? s[a].push(e) : s[a] = [e]),
        this
    },
    o.prototype.chat = function(a) {
        if (window.JSON && window.JSON.parse) return f(a),
        this
    },
    ...
    layui.data.content = function(a) {
        ...
        return a = (a || "").replace(/&(?!#?[a-zA-Z0-9]+;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/'/g, "&#39;").replace(/"/g, "&quot;").replace(/@(\S+)(\s+?|$)/g, '@<a href="javascript:;">$1</a>$2').replace(/\s{2}/g, "&nbsp;").replace(/img\[([^\s]+?)\]/g,
        function(a) {
    ...
    g = function() {
        ...
        if (a.content = e.textarea.val(), "" !== a.content) {
            ...
            o - (g.time || 0) > 6e4 && (t.append('<li class="layim-chat-system"><span>' + layui.data.date() + "</span></li>"), g.time = o),
            t.append(i(d).render(a));
            var m = {
                mine: a,
                to: l
            },
    ...
    v = function() {
        ...
        a.src = layui.cache.dir + "css/modules/layim/voice/" + y.base.voice,
        a.play()
    },
    b = {},
    x = function(a) {
        ...
        if (a.timestamp = a.timestamp || (new Date).getTime(), a.system || S(a), b = JSON.parse(JSON.stringify(a)), y.base.voice && v(), !u && a.content) {
            if (y.message[a.type + a.id]) y.message[a.type + a.id].push(a);
                ...
                layui.each(y.friend,
                function(e, i) {
                    if (layui.each(i.list,
                    function(e, i) {
                        if (i.id == a.id) return i.type = "friend",
                        i.name = i.username,
                        y.chat.push(i),
                        t = !0
                    }), t) return ! 0
                ...
                layui.each(y.group,
                function(e, t) {
                    if (t.id == a.id) return t.type = "group",
                    t.name = t.groupname,
                    y.chat.push(t),
                    n = !0
                }),
            ...
            y.chat.push(a);
            "group" === a.type && layui.each(y.group,
            function(t, i) {
                if (i.id == a.id) return e.avatar = i.avatar,
                !0
            }),
            !a.system
        }
        if (u) {
            ...
            a.system ? index !== -1 && c.append('<li class="layim-chat-system"><span>' + a.content + "</span></li>") : "" !== a.content.replace(/\s/g, "") && (a.timestamp - (g.time || 0) > 6e4 && (c.append('<li class="layim-chat-system"><span>' + layui.data.date(a.timestamp) + "</span></li>"), g.time = a.timestamp), c.append(i(d).render(a))),
            C()
        }
    },
    S = function(a) {
        ...
        t = e.chatlog || {};
        t[a.type + a.id] ? (t[a.type + a.id].push(a), t[a.type + a.id].length > c && t[a.type + a.id].shift()) : t[a.type + a.id] = [a],
        e.chatlog = t,
    ...
    w = function() {
        ...
        layui.each(t[e.data.type + e.data.id],
        function(a, e) { (new Date).getTime() > e.timestamp && e.timestamp - (g.time || 0) > 6e4 && (n.append('<li class="layim-chat-system"><span>' + layui.data.date(e.timestamp) + "</span></li>"), g.time = e.timestamp),
            n.append(i(d).render(e))
        }),
        C()
    },
    C = function() {
        ...
        if (i.length >= c) {
            var n = i.eq(0);
            t.prev().hasClass("layim-chat-system") || t.before('<div class="layim-chat-system"><span layim-event="chatLog">查看更多记录</span></div>'),
            n.remove()
        }
    ...
    k = function() {
        ...
        function(a) {
            var i = a.keyCode;
            13 === i && (a.preventDefault(), g()),
            t["" === e.val() ? "addClass": "removeClass"]("layui-disabled")
        })
    },
    j = function() {
    ...
    T = function(a, e, t) {
        var i, n = a.value;
        t || a.focus(),
        document.selection ? (i = document.selection.createRange(), document.selection.empty(), i.text = e) : (i = [n.substring(0, a.selectionStart), e, n.substr(a.selectionEnd)], t || a.focus(), a.value = i.join(""))
    },
    B = {
        chat: function(a) {
            var e = layui.data("layim-mobile")[y.mine.id] || {},
            ...
            l = {};
            "friend" === t ? l = y[t][i].list[n] : "group" === t ? l = y[t][n] : "history" === t && (l = (e.history || {})[i] || {}),
        ...
        face: function(a, e) {
            ...
            i = '<ul class="layui-layim-face">' + i + "</ul>",
            n.popBottom({
                content: i,
                success: function(a) {
                    ...
                    e.on("click",
                    function() {
                        return T(c[0], "face" + this.title + " ", !0),
                        c.next()["" === c.val() ? "addClass": "removeClass"]("layui-disabled"),
                        !1
                    })
                }
            }),
        ...
        image: function(a) {
            ...
            l({
                ...
                success: function(a) {
                    ...
                    "images" === e ? T(i.textarea[0], "img[" + (a.data.src || "") + "]") : "file" === e && T(i.textarea[0], "file(" + (a.data.src || "") + ")[" + (a.data.name || "下载文件") + "]"), g()) : n.msg(a.msg || "上传失败")
                }
            })
        },
        extend: function(a) {
